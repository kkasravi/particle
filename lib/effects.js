    ...
    var Fir = (function() {
      ...
      function Fir() {
        ...
        var ctor = function (_properties) {
          ...
          this.radialDistributionType=Effect.PARTICLE.TRAIL;
          this.randomX=50;
          this.randomY=50;
          this.spawnRate=6;
    ...
    var Galaxy = (function() {
      ...
      function Galaxy() {
        ...
        var ctor = function (_properties) {
          ...
          this.radialDistributionType=Effect.PARTICLE.FULL;
          this.randomX=60;
          this.randomY=60;
          this.spawnRate=2;
          this.spawnThreshold=0;
      ...
      Galaxy.prototype['render'] = function(ctx) {
        ...
        lifeRatio=this.attenuationStart + this.attenuationSpeed * Math.pow(lr,4);
