(function() {
  ...
  (function(require, exports, moduleId) {
    ...
    exports.Fir = Fir;
    var Steam = (function() {
      Steam.prototype = exports.Effect();
      ...
      function Steam() {
        ...
        var ctor = function (_properties) {
          ...
          Effect.call(this);
          this.attenuationType=Effect.ATTENUATION.GROW;
          this.attenuationStart=1.5;
          this.attenuationSpeed=1;
          this.backgroundColor="rgb(0,0,0)";
          ...
          this.colorifyType=Effect.PATTERN.SOLID;
          this.fingerSize=3;
          this.globalAlphaFree=0.1;
          this.globalAlphaTouch=0.1;
          this.globalCompositeOperationClear="source-over";
          this.globalCompositeOperationFree="source-over";
          this.globalCompositeOperationTouch="lighter";
          this.gravity=0;
          this.gravityEnabled=false;
          this.images=["/particle/img/snowflake7_alpha.png"];
          this.lifeMin=1;
          this.lifeMultiplierFree=7;
          this.lifeRange=3;
          this.lineWidth=0;
          this.palette=["rgba( 255, 255, 255, 0.15 )","rgba( 80, 155, 255, 0.15 )","rgba( 255, 175, 125, 0.15 )","rgba( 255, 100, 100, 0.15 )","rgba( 180, 180, 255, 0.15 )","rgba( 255, 0, 255, 0.15 )","rgba( 255, 125, 0, 0.15 )","rgba( 0, 125, 255, 0.15 )","rgba( 255, 0, 125, 0.15 )","rgba( 255, 125, 125, 0.15 )"];
          this.particleSize=3;
      ...
      Steam.prototype['render'] = function(ctx) {
        ctx.globalCompositeOperation="lighter";
        ctx.globalAlpha=this.globalAlphaTouch;
        ctx.lineWidth=this.lineWidth;
        var lifeRatio=1;
        lifeRatio=1 - this.life / this.totalLife;
        lifeRatio=this.attenuationStart + this.attenuationSpeed * lifeRatio;
      ...
      Steam.prototype['update'] = function(props) {
        this.life=this.lifeMin + this.lifeRange * Math.random();
        this.totalLife=this.life;
        this.angle=Math.random() * Effect.PI2;
      ...
      return function __() {
        var args = Array.prototype.slice.call(arguments);
        __.constructor = Steam;
        return new Steam(args && args.length && args[0]);
      };
    })();
    exports.Steam = Steam;
    var Galaxy = (function() {
      ...
      function Galaxy() {
        ...
        var ctor = function (_properties) {
          ...
          this.gravity=0;
          this.gravityEnabled=false;
          this.images=["/particle/img/spikey.png"];
          this.lifeMin=1;
          this.lifeMultiplierFree=5;
          this.lifeRange=2;
          this.lineWidth=0;
